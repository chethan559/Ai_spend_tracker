  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0a0a0b', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: 32, fontWeight: 700, marginBottom: 12 }}>Terms of Service</h1>
        <p style={{ color: '#71717a', fontSize: 16, marginBottom: 28 }}>Our terms of service are being drafted. Check back soon.</p>
